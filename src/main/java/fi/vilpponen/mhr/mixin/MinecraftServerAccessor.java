...
/**
 * The four private things a server keeps that building a world out of band needs.
 *
 ...
 *
 * <p>This is an accessor and nothing else: no behaviour is injected, and the decisions all live in
